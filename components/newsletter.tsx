      ...
      <div className="container mx-auto px-4 lg:px-8">
        <div className="relative max-w-4xl mx-auto">
            ...
            <div className="relative z-10 text-center">
              ...
              <p className="text-xs text-muted-foreground mt-4" aria-live="polite">No spam. Unsubscribe anytime.</p>
              <div
              ...
              <div id="newsletter-privacy" className="mt-2 text-[10px] text-muted-foreground">We protect your data. See our privacy policy.</div>
            </div>
          </div>
        </div>
      </div>
