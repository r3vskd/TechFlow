...
export default function Home() {
  return (
    <main id="main" className="min-h-screen pt-36" aria-labelledby="home-heading" aria-label="Home page">
      ...
      <div id="offers" className="scroll-mt-36" role="region" aria-label="Offers" tabIndex={-1} />
      <div id="products" className="scroll-mt-36" role="region" aria-labelledby="products-heading" tabIndex={-1}>
        <FeaturedProducts />
      </div>
      <div id="benefits" className="scroll-mt-36" role="region" aria-label="Benefits" tabIndex={-1}>
        <Benefits />
      </div>
